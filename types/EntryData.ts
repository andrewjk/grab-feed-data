...
export default interface EntryData {
   ...
   *
   * In RSS this is not used. In Atom this is the `link` field with `rel="alternate"`.
   * In JF this is the `external_url` field.
   */
  externalUrl?: string;
  permalink?: string;
  /**
   ...
   *
   * In RSS, Atom and JF this is the `author` field.
   */
  author?: PersonData;
  /**
   * Multiple authors who contributed to this entry.
   *
   * In RSS this is not used. In Atom this is the `contributor` fields. In JF this is
   * taken from the `authors` field.
   */
   ...
   *
   * In RSS and Atom this is not used.
   */
  image?: ImageData;
  /**
   * One or more categories that this entry belongs to.
   *
   * In RSS and Atom this is the `category` field. In JF this is the `fields` tag.
   */
  categories?: string[];
  /**
   * A description of the feed that this entry belongs to.
   *
   * In RSS this is the `source` field. In Atom this is the `link` field with `rel="via"`.
   */
  source?: SourceData;
  /**
